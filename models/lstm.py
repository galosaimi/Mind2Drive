...
lstm.py
-------
LSTM model wrapper and data loader for EEG-based driver intention classification.
...
class LSTMWrapper(nn.Module):
    def __init__(self, num_electrodes=16, hid_channels=64, num_classes=3):
        ...
        self.lstm = LSTM(num_electrodes=num_electrodes, hid_channels=hid_channels, num_classes=num_classes)
